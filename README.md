...
`git clone https://github.com/thedonwind69/galaxystays.git`

Open 2 separate terminal tabs, and cd into project folder on each. For each tab, one of them cd into the galaxystays/api/ folder and the other into galaxystays/client/:

`cd galaxystays/api`

`cd galaxystays/client`
